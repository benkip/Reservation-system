...
<ul>
<li class="active"><a href="account-accomm.php">Accommodation</a></li>
...
<tbody>
<?php
$query="select * from invoice where section_id=5 group by date_issued";
...
$qry="select invoice_number, date_issued, sum(amount) as amount from invoice where section_id=5 group by date_issued limit $offset,$rowsperpage"; 
