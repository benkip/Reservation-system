...
if(isset($_POST['submit'])) {
	...
	update("insert into season values ('".$id."','".$season."','".$start."','".$end."')");
...
<li class="active"><a href="addseason.php">Add Season</a></li>
</ul>
</div>
</div>
...
<label>Start Date:</label><div class="cal"><input type="date" name="start_date" id="start"><div class="cal">
<label>End Date :</label><div class="cal"><input type="date" name="end_date" id="end"><div class="cal">
<label>Season Name :</label><input type="text" name="season" value="name">
<div class="controls">
