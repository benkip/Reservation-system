...
$rooms=getRoomData($offset,$rowsperpage);
foreach($rooms as $i=>$value):
$link='room.php?number='.$value['room_no'];
$more='room-availability.php?number='.$value['room_no'];
$update='updateroom.php?number='.$value['room_no'];?>
<tr class="table-content"><td><input type="checkbox" name="room[]" value="<?php echo $value['room_no']; ?>" /></td>
<td><?php echo $value['room_no']; ?></td>
<td><?php echo $value['name']; ?></td>
<td><?php echo $value['category']."&nbsp; ". $value['room_description']; ?></td>
<td><a href="<?php echo $update; ?>"><img src="images/edit.png"></a><a href="#"><img src="images/delete.png"></a><a href="<?php echo $more; ?>" target="_blank"><img src="images/more.png"></a></td></tr>
<?php endforeach; ?>
</tbody>
</table>
