...
<li  class="active"><a href="season.php">Seasons</a></li>
...
$rooms=getSeasonData($offset,$rowsperpage);
foreach($rooms as $i=>$value):
$link='updateseason.php?id='.$value['season_id'];
$del=$_SERVER['PHP_SELF'].'?id='.$value['season_id'];?>
<tr class="table-content"><td width="20"><input type="checkbox" name="season[]" value="<?php echo $value['season_id']; ?>" /></td>
<td><?php echo $value['season_id']; ?></td>
